...
$oggpicconi=$db->QueryCiclo("SELECT t1.oggid AS oggid,t1.count(t1.id) AS numero FROM inoggetti AS t1 JOIN oggetti t2 ON t1.oggid=t2.id WHERE t1.userid='".$user['userid']."' AND t2.tipo='2' AND t2.categoria='1' GROUP BY t1.oggid");
