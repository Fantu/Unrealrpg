...
<td valign="middle"><table width="100" style="height: 10px"><tr><td width="<?php echo $percmin1; ?>" class="sfondoverde"></td><td width="<?php echo $percmin2; ?>" class="sfondorosso"></td></tr></table><br />
</td></tr></table>