...
$menu->View('m','info');
$menu->View('v','opzioni'); ?>
<ul><li><a href="#"><?php echo $lang['Link']; ?></a><ul><li><a href="http://www.lostgames.net/forum/forumdisplay.php?f=33" target="_blank">Forum</a></li><li><a href="http://fantu.eu:8080" target="_blank"><?php echo $lang['Traduzione']; ?></a></li><li><a href="http://fantu.eu/bugtracker/index.php?project=2" target="_blank"><?php echo $lang['Bugtracker']; ?></a></li></ul></li></ul>
