...
<table width="122"  border="1" cellspacing="1" cellpadding="1" class="tabmenu">		  
	...
	<tr>
    <td class="tabmenutd" id="menu4" onmouseover="cambiaclasse(this.id,'tabmenutd2')" onmouseout="cambiaclasse(this.id,'tabmenutd')"><div align="center"><a href="game.php?act=changelog"><?php echo $lang['Changelog']; ?></a></div></td>
	</tr>
	<tr>
    <td class="tabmenutd" id="menu5" onmouseover="cambiaclasse(this.id,'tabmenutd2')" onmouseout="cambiaclasse(this.id,'tabmenutd')"><div align="center"><a href="game.php?act=logout"><?php echo $lang['Logout']; ?></a></div></td>
	</tr>		
</table>
</div>