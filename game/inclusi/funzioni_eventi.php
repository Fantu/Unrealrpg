...
$danni=0;
if($esplosione>10){
$esplosione=rand(30,100)-($usercar['minatore']*5)-($usercar['agilita']/20)-($usercar['attfisico']/10);
if($esplosione<10){
...
$danni=0;
if($esplosione>10){
$esplosione=rand(30,100)-($usercar['alchimista']*5)-($usercar['agilita']/20)-($usercar['attmagico']/10);
if($esplosione<10){
