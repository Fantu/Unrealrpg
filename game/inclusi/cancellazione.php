...
$tempo=$adesso-172800;
$dacanc=$db->QuerySlect("SELECT count(userid) AS id FROM utenti WHERE dataiscrizione<'".$tempo."' AND conferma='0'");
...
$tempo=$adesso-259200;
$dacanc=$db->QuerySlect("SELECT count(userid) AS id FROM utenti WHERE dataiscrizione<'".$tempo."' AND personaggio='0'");
