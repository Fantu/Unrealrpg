...
$lang['testo_mail_codice_conferma']="Ciao %3s, Per confermare manualmente l`iscrizione a %1s utilizza il codice seguente: %2s Saluti,\n %1s Staff";// %1$s=nome del gioco %2$s=codice %3$s=username
