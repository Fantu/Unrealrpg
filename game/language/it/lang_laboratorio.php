...
$lang['lab_errore2']='- Attualmente il tuo fisico non pu&ograve; reggere il lavoro in Laboratorio.<br />';
...
$lang['lab_errore5']='- Non hai abbastanza ampolle per poter effettuare esperimenti o distillare pozioni.<br />';
$lang['lab_errore6']='- Non hai abbastanza monete per comprare gli ingredienti necessari.<br />';
$lang['lab_errore7']='- Non sei abbastanza abile per poter creare questa pozione.<br />';
$lang['lab_errore8']='- Non hai selezionato la pozione da creare!<br />';
...
$lang['report_lavlabalc']='Hai lavorato in Laboratorio come alchimista per 1 ora, guadagnando %s di esperienza. Il lavoro ti ha stancato (hai perso %s di energia), il tuo fisico ne ha risentito (hai perso %s di salute) e hai consumato %s di mana.<br />Hai speso %s monete per comprare gli ingredienti necessari.';
