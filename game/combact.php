...
$outputcombact="<table width=\"500\" align=\"center\">".$report."</table><br />".sprintf($lang['secondi_prox_round'],$sec_prox_round)."<br /><br /><form action=\"index.php?loc=combact#fondo\" method=\"post\" name=\"formaggiorna\"><input name=\"Submit\" type=\"submit\" value=\"".$lang['aggiorna']."\" /></form><br />";
